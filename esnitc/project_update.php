...
<body>
 ...
 <li>  <a href='#'>Edit Profile</a></li>
     <li> <form action='check1.php' method='post'><input type='Submit' value='My Projects' name='option'></form></li>
  ...
  #</li>
          ...
          <div class='container-fluid text-center'>    
            <div class='row content'>
              ...
              <br><br>
                <p><form action='check1.php' method='post'><input type='Submit' value='Post New Project' name='option'></form></p><br><br>
                    ...
                    <tr> -->
                      <?php
                            ...
                            if($option=='submit')
                            {
                             ...
                             # echo "hiii ".$pid,$title;
                              #$user=$_SESSION['user'];
                              $sql="update store set name='$title',field='$field',description='$description',status='$status' where pid='$pid';";
                              $result=mysqli_query($conn,$sql);
                              if($result)
                              {
                                
                                      echo "Project Updated successfully";
                                       $sql1 = "SELECT * FROM store where pid='$pid';";
                              ...
                              // echo '<tr>'.'<th>name</th>'.'<th>pid</th>'.'<th>field</th>'.'<th>description</th></tr>';
                                ...
                                echo "</table></center><br><br>";
                                    ...
                                    {
                                      echo "Welcome Please Post a Project<br>";
                                    }
                            
                            }
                            else
                            {
                              #echo "Error occurred in Updating project";
        ...
        #$msg=mysqli_error($conn);
                            ...
                            $sql = "SELECT DISTINCT * FROM store,project where store.pid='$pp';";
                            $result = mysqli_query($conn,$sql);
                            ...
                            if ($result->num_rows > 0) {
                              ...
                              echo "<h2>Update Project</h2><br><br>";
                              echo "<form action='project_update.php' method= 'Post' >
                              <div class='form-group'>
    <label for='exampleInputEmail1'>Project ID</label>
    <input type='text' class='form-control' id='exampleInputEmail1' aria-describedby='emailHelp' placeholder='Project Id' name='pid' value='$pp'>
    
  <div class='form-group'>
    <label for='exampleInputEmail1'>Title</label>
    <input type='text' class='form-control' id='exampleInputEmail1' aria-describedby='emailHelp' placeholder='Project Title' name='title' value='$title'>
    <small id='emailHelp' class='form-text text-muted'>ex: NITC EDUCENTER</small>
  </div>
             
                <div class='form-group'>
    <label for='field'>Field</label>
    <input type='text' class='form-control' id='field' aria-describedby='emailHelp' placeholder='field of the project' value='$field' name='field'>
    <small id='Field' class='form-text text-muted'>ex: Web development</small>
  </div>
                
                <div class='form-group'>
    <label for='Description'>Description</label>
    <input type='text' class='form-control' id='Description' aria-describedby='Description' placeholder='Description of the project' value='$description' name='description'>
