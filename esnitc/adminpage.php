...
<body>
            ...
            <div class='container-fluid'>
              ...
              <div class='collapse navbar-collapse' id='myNavbar'>
                ...
                <ul class='nav navbar-nav navbar-right'>
                  ...
                  echo "<li><a href='signup.php'><span class='glyphicon glyphicon-user'></span> Admin</a></li>"
                  ;
                } else
                {
  ...
  <button class='btn btn-primary dropdown-toggle' type='button' data-toggle='dropdown'>&nbsp " . "<label>admin</label>"."&nbsp
  ...
  #</li>
          ...
          <div class='container-fluid text-center'>    
            <div class='row content'>
              ...
              <br><br>
                <p><form action='checkadmin.php' method='post'><input type='Submit' value='Add project' name='option'></form></p><br><br>
                <p><form action='checkadmin.php' method='post'><input type='Submit' value='Add new fields' name='option'></form></p><br><br>
                <p><a href='#'>Chat room</a></p><br><br>
               <p><form action='checkadmin.php' method='post'><input type='Submit' value='delete project' name='option'></form></p><br><br>
                  ...
                  <tbody>
                    <tr> -->
                      <?php
			                      ...
			                      $sql = "SELECT * FROM store order by pid desc;";
