var myApp = angular
				...
				myApp.controller("userController", ['$scope','$http', function($scope,$http){
					getdetails();
					function getdetails(){
						$http.get('http://192.168.40.99/kranthikiran_b130417cs/educenter/database/showproject.php').success(function(data){
							$scope.details = data;
							console.log(data);
						});
					};
				    ...
				    myApp.controller('signupController', ['$scope', '$http', function($scope,$http){
				      ...
				      function givedetails(){
						$http.get('http://192.168.40.99/kranthikiran_b130417cs/educenter/database/signupinsertuser.php').success(function(data){
				          $scope.details = data;
				          console.log(data);
				        });
